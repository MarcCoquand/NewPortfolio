...
var _user$project$Types_Types$ContactFormChangeEmail = function (a) {
	return {ctor: 'ContactFormChangeEmail', _0: a};
};
var _user$project$Types_Types$ContactFormChangeName = function (a) {
	return {ctor: 'ContactFormChangeName', _0: a};
};
var _user$project$Types_Types$ContactFormChange = function (a) {
	return {ctor: 'ContactFormChange', _0: a};
};
var _user$project$Types_Types$HeaderImgLoaded = function (a) {
	return {ctor: 'HeaderImgLoaded', _0: a};
};
var _user$project$Types_Types$NoOp = {ctor: 'NoOp'};
		...
		switch (_p0.ctor) {
			...
			case 'HeaderImgLoaded':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{showHeaderImg: _p0._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ContactFormChange':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{contactFormMessage: _p0._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ContactFormChangeName':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{contactFormName: _p0._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ContactFormChangeEmail':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
...
var _user$project$View_Header$header = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('white cover flex flex-column pa3-ns relative '),
			_1: {
				ctor: '::',
				_0: _user$project$View_Header$showHeaderImg(model),
				_1: {ctor: '[]'}
			}
		},
		{
...
var _user$project$View_Process$process = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('flex flex-column pa5'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('f3 i center garamond'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('It all begins with a need...'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
...
var _user$project$View_Features$feature = F2(
	function (feat, icon) {
		return A2(
			_elm_lang$html$Html$div,
			{
...
var _user$project$View_Features$green = A3(_elm_lang$core$Color$rgb, 72, 177, 119);
var _user$project$View_Features$features = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'backgroundColor',
								_1: _eskimoblood$elm_color_extra$Color_Convert$colorToCssRgb(_user$project$View_Features$green)
							},
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Why you should hire me:'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('flex flex-column ph3-ns ph1-m flex-row-l'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
...
var _user$project$View_Features$Right = {ctor: 'Right'};
var _user$project$View_Features$Left = {ctor: 'Left'};

var _user$project$View_ContactForm$contactForm = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('f5 tc mb3'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Let\'s get in touch:'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
					...
					_elm_lang$html$Html$input,
					{
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$value(model.contactFormName),
									_1: {ctor: '[]'}
								}
							}
						}
						...
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value(model.contactFormEmail),
										_1: {ctor: '[]'}
									}
								}
							}
					...
					_1: {
							...
							_elm_lang$html$Html$textarea,
							{
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$value(model.contactFormMessage),
											_1: {ctor: '[]'}
										}
									}
								}
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_user$project$Types_Types$SendForm),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('mt2 bg-light-gray ba b--light-gray'),
										_1: {ctor: '[]'}
									}
								},
								{
...
var _user$project$View_View$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('montserrat'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _user$project$View_Header$header(model),
			_1: {
				ctor: '::',
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{init: _user$project$Main$init, view: _user$project$View_View$view, update: _user$project$Update_Update$update, subscriptions: _user$project$Subscriptions_Subscriptions$subscriptions})();
